...
app.get('/projects',(req, res)=>{
    res.json([{id: 1,
        ...
        description: 'A full stack ecommerce application built with the MERN stack featuring product listings, dynamic routing, and a REST API backend.', 
        techStack: ['MongoDB', 'Express', 'React', 'Node js'],
        githubLink: 'https://github.com/Kheiroum2000/mern-ecommerce',
